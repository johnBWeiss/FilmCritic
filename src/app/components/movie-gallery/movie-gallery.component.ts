...
export class MovieGalleryComponent implements OnInit {
  ...
  // };
  movies: any = [];
  // this.rawMovieData.items.slice(
  // (this.pageCounter - 1) * this.formerItemsOnDisplay,
  // this.pageCounter * this.itemsOnDisplay - this.itemsOnDisplay,
  // 0,
  // this.pageCounter * this.formerItemsOnDisplay
  ...
  searchOneMovie() {
    ...
    this.movies = this.movies.splice(0);
    this.movies = { stop: 'stop' };
    this.rawMovieData = '';
    this.showSpinner = true;
